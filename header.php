                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hero__text">
                            ...
                            <h1 class="wow fadeInUp"><span class="light">LEARN</span> <span class="middle">TRAIN</span> PLAY</h1>
                            <p class="wow fadeInUp">L’Application qui révolutionne le Fitness ! <br>Des séances motivantes, totalement interactives, fun, <br>avec des experts qualifiés. Le tout sans bouger de chez vous !</p>
                            <div class="signup__form wow fadeInUp">
