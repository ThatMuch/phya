...
function phya_enqueue() {
  ...
  // scripts
		wp_register_script('phya_/scrolloverflow', get_template_directory_uri() . '/assets/js/scrolloverflow.min.js', false, array( 'jquery' ), true);
		  wp_enqueue_script('phya_/scrolloverflow');
		wp_register_script('phya_/easings', get_template_directory_uri() . '/assets/js/easings.min.js', false, array( 'jquery' ), true);
		  wp_enqueue_script('phya_/easings');
		wp_register_script('phya_/aos', get_template_directory_uri() . '/assets/js/aos.min.js', false, array( 'jquery' ), true);
  wp_enqueue_script('phya_/aos');
	  wp_register_script('phya_/wow', get_template_directory_uri() . '/assets/js/wow.min.js', false, array( 'jquery' ), true);
  wp_enqueue_script('phya_/wow');
	  wp_register_script('phya_/fullpage', get_template_directory_uri() . '/assets/js/fullpage.min.js', false, array( 'jquery' ), true);
  wp_enqueue_script('phya_/fullpage');
	  wp_register_script('phya_/js_vendor', get_template_directory_uri() . '/assets/js/vendor.min.js', false, array( 'jquery' ), true);
  wp_enqueue_script('phya_/js_vendor');
  wp_register_script('phya_/js', get_template_directory_uri() . '/assets/js/custom.min.js', false, array( 'jquery' ), true);
  wp_enqueue_script('phya_/js');



  // styles
  wp_enqueue_style('phya_/styles', get_template_directory_uri() . '/style.min.css', false, null);
  // Typekit
  global $typekit_id;
  if ($typekit_id) :
    ...
    wp_enqueue_script('wp-bootstrap-starter-popper', get_template_directory_uri() . '/inc/assets/js/popper.min.js', array(), '', true );
	  wp_enqueue_script('bootstrapjs', get_template_directory_uri() . '/inc/assets/js/vendor/bootstrap.bundle.min.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-starter-themejs', get_template_directory_uri() . '/inc/assets/js/theme-script.min.js', array(), '', true );
	  wp_enqueue_script( 'wp-bootstrap-starter-skip-link-focus-fix', get_template_directory_uri() . '/inc/assets/js/skip-link-focus-fix.min.js', array(), '20151215', true );
}

add_action('wp_enqueue_scripts', 'phya_enqueue');
...
add_action( 'after_setup_theme', 'phya_theme_support');
...
add_action('after_setup_theme', 'phya_wphead_cleanup');


/* 2.2 LOAG OG-TAGS
/––––––––––––––––––––––––*/
// loads open graph tags » http://ogp.me/
// use 'phya_load_ogtags(true)' to also display the og:image tag
function phya_ogtags() {
  echo '
